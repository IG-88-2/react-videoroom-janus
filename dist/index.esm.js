...
class JanusPublisher extends EventTarget {
    constructor(options) {
        ...
        this.renegotiate = ({ audio, video }) => __awaiter$1(this, void 0, void 0, function* () {
            const jsep = yield this.createOffer(this.mediaConstraints);
        ...
        this.createOffer = (mediaConstraints) => __awaiter$1(this, void 0, void 0, function* () {
        ...
        this.attach = () => __awaiter$1(this, void 0, void 0, function* () {
            const request = {
                type: "attach",
                load: {
                    room_id: this.room_id
        ...
        this.configure = (data) => __awaiter$1(this, void 0, void 0, function* () {
            const request = {
                type: "configure",
                load: {
                    room_id: this.room_id,
        ...
        this.publish = ({ jsep }) => __awaiter$1(this, void 0, void 0, function* () {
            const request = {
                type: "publish",
                load: {
                    room_id: this.room_id,
        ...
        this.joinandconfigure = (jsep) => __awaiter$1(this, void 0, void 0, function* () {
            const request = {
        ...
        this.unpublish = () => __awaiter$1(this, void 0, void 0, function* () {
            const request = {
                type: "unpublish",
                load: {
                    room_id: this.room_id,
        ...
        this.detach = () => __awaiter$1(this, void 0, void 0, function* () {
            const request = {
                type: "detach",
                load: {
                    room_id: this.room_id,
        ...
        this.hangup = () => __awaiter$1(this, void 0, void 0, function* () {
            const request = {
                type: "hangup",
                load: {
                    room_id: this.room_id,
...
class JanusSubscriber extends EventTarget {
    constructor(options) {
        super();
        this.initialize = (options) => __awaiter$1(this, void 0, void 0, function* () {
            yield this.attach();
        ...
        this.createAnswer = (jsep, options) => __awaiter$1(this, void 0, void 0, function* () {
...
class JanusClient {
    constructor(options) {
        ...
        this.cleanup = () => __awaiter$1(this, void 0, void 0, function* () {
            if (this.publisher) {
        ...
        this.join = (room_id) => __awaiter$1(this, void 0, void 0, function* () {
            this.room_id = room_id;
            if (this.publisher) {
                try {
                    yield this.publisher.terminate();
        ...
        this.onEvent = (json) => __awaiter$1(this, void 0, void 0, function* () {
        ...
        this.onPublishers = (publishers) => __awaiter$1(this, void 0, void 0, function* () {
        ...
        this.onLeaving = (json) => __awaiter$1(this, void 0, void 0, function* () {
            if (!json.data) {
                this.logger.json(json);
        ...
        this.mute = () => __awaiter$1(this, void 0, void 0, function* () {
            if (!this.publisher) {
        ...
        this.unmute = () => __awaiter$1(this, void 0, void 0, function* () {
            if (!this.publisher) {
        ...
        this.pause = () => __awaiter$1(this, void 0, void 0, function* () {
            if (!this.publisher) {
        ...
        this.resume = () => __awaiter$1(this, void 0, void 0, function* () {
            if (!this.publisher) {
...
class Video extends Component {
    ...
    render() {
        ...
        return createElement("video", { id: id, muted: muted, autoPlay: true, style: style, ref: (video) => { this.video = video; } });
    }
}
class JanusVideoRoom extends Component {
    constructor(props) {
        super(props);
        ...
        this.renderVideo = (subscriber) => {
            ...
            return createElement("div", { style: this.styles.videoContainer },
                createElement(Video, { id: subscriber.id, muted: false, style: this.styles.video, stream: subscriber.stream }));
        };
        this.renderLocalVideo = () => {
            ...
            return (createElement("div", { style: this.styles.localVideoContainer },
                createElement(Video, { id: publisher.id, muted: true, style: this.styles.localVideo, stream: publisher.stream })));
        };
        this.renderContainer = () => {
            if (!this.client || !this.client.subscribers) {
                return null;
            }
            const subscribers = Object.values(this.client.subscribers).filter((element) => element && element.ptype === "subscriber");
