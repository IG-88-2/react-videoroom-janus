...
class JanusClient {
    constructor(options) {
        ...
        this.join = (room_id, mediaConstraints) => __awaiter$1(this, void 0, void 0, function* () {
            this.room_id = room_id;
            if (this.publisher) {
                try {
...
class Video extends Component {
    ...
    render() {
        ...
        return createElement("video", { id: `video-${id}`, muted: muted, style: style, ref: (video) => { this.video = video; } });
    }
}
class JanusVideoRoom extends Component {
    constructor(props) {
        ...
        this.renderVideo = (subscriber) => {
            ...
            return createElement("div", { key: `subscriber-${subscriber.id}`, style: this.state.styles.videoContainer },
                createElement(Video, { id: subscriber.id, muted: false, style: this.state.styles.video, stream: subscriber.stream }));
        };
        this.renderLocalVideo = () => {
            ...
            return (createElement("div", { style: this.state.styles.localVideoContainer },
                createElement(Video, { id: publisher.id, muted: true, style: this.state.styles.localVideo, stream: publisher.stream })));
        };
        this.getSubscribers = () => {
        ...
        this.renderContainer = () => {
            ...
            return (createElement("div", { style: this.state.styles.container }, content));
        };
        this.onParticipantsAmountChange = () => {
